            ...
            {Boolean(state.results.length) && (
              <div className="list-group shadow-sm">
                ...
                {state.results.map(post => {
                  return <Post post={post} /*passing a props here*/ key={post._id} /* defining key for performance reasons */ onClick={() => appDispatch({ type: "closeSearch" })} /*Passing props for search to close once results is clicked */ />
                })}
              </div>
            )}
